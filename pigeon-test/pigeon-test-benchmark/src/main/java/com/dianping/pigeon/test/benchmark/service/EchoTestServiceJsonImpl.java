...
@Service(url = "com.dianping.pigeon.test.benchmark.service.EchoTestServiceJsonImpl")
public class EchoTestServiceJsonImpl implements EchoTestService {

	@Reference(url = "com.dianping.pigeon.demo.EchoService", serialize = "json")
	...
	public EchoTestServiceJsonImpl() {
		KryoSerializer.registerClass(EchoService.class, 1001);
	}

	static EchoTestServiceJsonImpl instance = new EchoTestServiceJsonImpl();
