...
public class FailoverClusterEchoServiceTest extends BaseInvokerTest {

    @PigeonAutoTest(url = "http://service.dianping.com/testService/echoService_1.0.0", cluster = "failover")
