...
import com.dianping.pigeon.remoting.common.codec.thrift.ThriftAnnotationSerializer;
        ...
        if (!isInitialized) {
            synchronized (SerializerFactory.class) {
                if (!isInitialized) {
                    ...
                    registerSerializer(THRIFT, SERIALIZE_THRIFT, new ThriftAnnotationSerializer());
