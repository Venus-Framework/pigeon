...
public class ResponseInfo implements org.apache.thrift.TBase<ResponseInfo, ResponseInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ResponseInfo> {
  ...
  public ResponseInfo setStatus(StatusCode status) {
    this.status = status;
    return this;
  }
        ...
        switch (schemeField.id) {
          ...
          case 2: // STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.status = com.dianping.pigeon.remoting.common.domain.generic.thrift.StatusCode.findByValue(iprot.readI32());
