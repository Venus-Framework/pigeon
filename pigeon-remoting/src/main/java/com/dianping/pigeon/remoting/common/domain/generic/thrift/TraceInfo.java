...
public class TraceInfo implements org.apache.thrift.TBase<TraceInfo, TraceInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TraceInfo> {
  ...
  private static final _Fields optionals[] = {_Fields.TRACE_ID,_Fields.SPAN_ID,_Fields.ROOT_MESSAGE_ID,_Fields.CURRENT_MESSAGE_ID,_Fields.SERVER_MESSAGE_ID,_Fields.DEBUG,_Fields.SAMPLE};
  ...
  public void validate() throws TException {
    ...
    if (clientAppkey == null) {
      throw new TProtocolException("Required field 'clientAppkey' was not present! Struct: " + toString());
    }
  ...
  private static class TraceInfoStandardScheme extends StandardScheme<TraceInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TraceInfo struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TraceInfo struct) throws TException {
      struct.validate();
  ...
  private static class TraceInfoTupleScheme extends TupleScheme<TraceInfo> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TraceInfo struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TraceInfo struct) throws TException {
