...
public class LionCuratorRegistry implements Registry {

	private static Logger logger = LoggerLoader.getLogger(LionCuratorRegistry.class);
			...
			synchronized (this) {
				if (!inited) {
					try {
						...
						client = new LionCuratorClient(zkAddress);
	...
	public LionCuratorClient getLionCuratorClient() {
		return client;
	}
	...
	@Override
	public String getServiceAddress(String serviceName, String group,
