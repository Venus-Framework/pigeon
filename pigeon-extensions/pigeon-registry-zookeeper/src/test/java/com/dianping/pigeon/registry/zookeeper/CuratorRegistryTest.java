...
public class CuratorRegistryTest {
    ...
    public void testRegisterService2() throws Exception {
        ...
        List<String> newHosts = registry.getNewServiceAddress("srv_a", "group_a");
        assertEquals(newHosts.size(), 2);
        assertTrue(newHosts.contains("1.1.1.4:1234"));
        assertTrue(newHosts.contains("1.1.1.5:1234"));
