 ...
 *         2016/06/21  下午3:36.
 */
public class NettyClientHandler_ extends SimpleChannelUpstreamHandler {

    private static final Logger logger = LoggerLoader.getLogger(NettyClientHandler_.class);

    private NettyClient client;

    public NettyClientHandler_(NettyClient client) {
        this.client = client;
    }
