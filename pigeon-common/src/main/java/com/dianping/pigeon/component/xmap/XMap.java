...
import com.dianping.pigeon.component.xmap.annotation.XParent;
...
public class XMap {
	...
	/**
	 * ���<code>Contribution</code>������ɶ�Ӧ��dom����
	 * 
	 * @param contribution
	 ...
	 *             <code>Exception</code>ʵ��
	 */
	public String asXmlString(Object contribution, String encoding, List<String> filters, boolean pretty)
			throws Exception {
	...
	protected static XObject checkObjectAnnotation(AnnotatedElement ae, ClassLoader classLoader) {
		/*
		 * Class<XObject> xobject = null; try { xobject = (Class<XObject>)
		 * classLoader
		 * .loadClass("com.alipay.sofa.common.xmap.annotation.XObject"); } catch
		 * (ClassNotFoundException e) { xobject = XObject.class; }
		 */
