 ...
 */
@Plugin(name = "PigeonAsync", category = "Core", elementType = "appender", printObject = true)
public final class PigeonAsyncAppender extends AbstractAppender {
    ...
    private PigeonAsyncAppender(final String name, final Filter filter, final AppenderRef[] appenderRefs,
     ...
     */
    @PluginFactory
    public static PigeonAsyncAppender createAppender(@PluginElement("AppenderRef") final AppenderRef[] appenderRefs,
        ...
        return new PigeonAsyncAppender(name, filter, appenderRefs, errorRef,
