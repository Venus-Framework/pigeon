 ...
 * </p>
 */
@Plugin(name = "PigeonRolloverStrategy", category = "Core", printObject = true)
public class PigeonRolloverStrategy implements RolloverStrategy {
     ...
     */
    @PluginFactory
    public static PigeonRolloverStrategy createStrategy(
     ...
     */
    protected PigeonRolloverStrategy(final int minIndex, final int maxIndex, final boolean useMax, final int compressionLevel, final StrSubstitutor subst) {
